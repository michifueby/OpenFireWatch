...
const T: Record<Lang, Record<string, string>> = {
  de: {
    title: 'Lagebericht',
    subtitle: 'Frühwarnsystem für thermische Anomalien',
    ...
    onDetection: 'eskaliert bei jeder glaubwürdigen Detektion',
    ...
    notWeather: 'keine Wetterfrage — eskaliert bei Detektion',
  ...
  en: {
    ...
    subtitle: 'Early warning system for thermal anomalies',
    generated: 'Generated',
    software: 'Software',
    ...
    onDetection: 'escalates on any credible detection',
    ...
    notWeather: 'not a weather question — escalates on detection',

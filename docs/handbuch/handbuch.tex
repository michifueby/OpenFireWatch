...
verschwindet aus der Liste, der pulsierende Punkt auf der Karte hört auf, und
im Verlauf bleibt der Eintrag mit einem grünen Haken und dem Zeitpunkt
erhalten.

Eine Quittierung gilt \emph{für alle} --- auf jedem Gerät, das die Karte
geöffnet hat, und auch nach einem Neuladen. Damit sie niemand Fremdes auslösen
kann, ist sie wie das Bearbeiten von Zonen durch den Betreiber-Schlüssel
geschützt: Ohne entsperrtes Panel \enquote{Gefahrenzonen} bleibt der Alarm
stehen und die Oberfläche sagt Ihnen, warum. Wer die Karte nur ansieht, kann
also nichts abschalten.
